...
all: linuxsb boot_prep power_prep capture

linuxsb: linux_prep boot_prep power_prep capture
...
bareboxsb: power_prep boot_prep capture
...
capture:
	@echo "build capture"
	$(MAKE)  -C capture  ARCH=$(ARCH) BOARD=$(BOARD)

updater: linux_prep boot_prep power_prep capture
...
clean:
	...
	$(MAKE) -C capture clean ARCH=$(ARCH)
	$(MAKE) -C power_prep clean ARCH=$(ARCH)

.PHONY: all linuxsb bareboxsb build_prep linux_prep boot_prep power_prep capture distclean clean
